...
export default function Home() {
  ...
  return (
    <div className="bg-bg-pattern">
      <div className="grid sm:grid-rows-[5rem_1fr_100px] grid-rows-[10rem_1.4rem_10rem] grid-cols-[1fr_2fr_1fr] items-center justify-items-center min-h-screen pb-9 gap-0 text-[#025392] font-[family-name:oswald]">
        ...
        <main className="flex flex-col w-full items-center justify-center gap-0 row-start-1 col-start-2">
          <div className="sm:top-[90%] top-[29rem] bg-gradient-to-b from-[#025392] to-[#0271bb] rounded-md border-[#025392] left-0 w-full h-auto text-center items-center justify-center z-30 absolute p-1.5 text-blue-50 text-black">
